export const translations = {
  en: {
    ...
    mission: {
      eyebrow: "Our Mission",
      title: "One Family, Three Missions",
      ...
      p4: "And our father gives the third its roots: trees and plants offered to families — living gifts, cared for the way we care for everything we give.",
    ...
    founder: {
      ...
      paragraphs: [
        ...
        "I founded this project, but I do not carry it alone. My siblings carry it with me — our elders leading the way — and it is our whole family that keeps our parents' lessons alive.",
      ],
  ...
  fr: {
    ...
    mission: {
      ...
      title: "Une Famille, Trois Missions",
      ...
      p4: "Et notre père donne ses racines à la troisième : des arbres et des plantes offerts aux familles — des dons vivants, entretenus comme tout ce que nous donnons.",
    ...
    founder: {
      ...
      paragraphs: [
        ...
        "J'ai fondé ce projet, mais je ne le porte pas seul. Mes frères et sœurs le portent avec moi — les aînés en tête — et c'est toute notre famille qui fait vivre les leçons de nos parents.",
      ],
